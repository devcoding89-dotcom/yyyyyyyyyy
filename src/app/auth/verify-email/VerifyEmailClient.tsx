      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-6">
            ...
            {resendMessage && (
              <div
                className={`text-center text-sm ${
                  resendMessage.includes("Failed") || resendMessage.includes("error") ? "text-destructive" : "text-green-600"
                }`}
              >
                {resendMessage}
              </div>
          ...
          <div className="text-center text-xs text-muted-foreground">
            ...
            <a href="mailto:support@emailcraft.studio" className="font-medium text-primary hover:underline">
